...
Najważniejsze ustawienia są opisane w `config.example.json` i obejmują: `enabled`, progi punktów, promień wyszukiwania, czasy oczekiwania między atakami, `max_farms`, `farm_scout_amount` oraz szczegółowe reguły A/B/C dla wyboru przycisku farm assistant.
